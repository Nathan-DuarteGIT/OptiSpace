...
<body class="bg-primaryfont-sans">
    ...
    <section id="inicio" class="mr-40 ml-40 flex items-center my-20">
        <div class="flex-1">
            ...
            <div class="mt-5">
                <a class="btn-outline mr-4" href="#juntese">Comece agora</a>
    ...
    <section id="servicos" class="mx-40 relative flex flex-col justify-center text-center my-20 overflow-hidden">
